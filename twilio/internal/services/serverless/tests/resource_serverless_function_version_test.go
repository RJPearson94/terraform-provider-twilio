	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateIdFunc:       testAccTwilioServerlessFunctionVersionImportStateIdFunc(stateResourceName),
...
func testAccTwilioServerlessFunctionVersionImportStateIdFunc(name string) resource.ImportStateIdFunc {
	return func(s *terraform.State) (string, error) {
		...
		return fmt.Sprintf("/Services/%s/Functions/%s/Versions/%s", rs.Primary.Attributes["service_sid"], rs.Primary.Attributes["function_sid"], rs.Primary.Attributes["sid"]), nil
	}
}
