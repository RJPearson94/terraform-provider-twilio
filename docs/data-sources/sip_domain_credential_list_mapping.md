---
page_title: "twilio_sip_domain_credential_list_mapping Data Source - twilio"
subcategory: "SIP"
description: |-
...
- `account_sid` (String) The SID of the account that owns this SIP domain credential list mapping
- `domain_sid` (String) The SID of the SIP domain the credential list is mapped to
- `sid` (String) The SID of the SIP domain credential list mapping to look up
