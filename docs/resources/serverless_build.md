...
- `runtime` - (Optional) The target runtime of the serverless functions and assets. Valid values are `node16` or `node18`. Changing this forces a new resource to be created
