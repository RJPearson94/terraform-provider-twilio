		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(stateResourceName, "limits.0.channel_members", "100"),
					resource.TestCheckResourceAttr(stateResourceName, "limits.0.user_channels", "250"),
					...
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.added_to_channel.0.enabled", "false"),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.added_to_channel.0.template", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.added_to_channel.0.sound", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.removed_from_channel.#", "1"),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.removed_from_channel.0.enabled", "false"),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.removed_from_channel.0.template", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.removed_from_channel.0.sound", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.invited_to_channel.#", "1"),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.invited_to_channel.0.enabled", "false"),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.invited_to_channel.0.template", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.invited_to_channel.0.sound", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.new_message.#", "1"),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.new_message.0.enabled", "false"),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.new_message.0.template", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.new_message.0.sound", ""),
					resource.TestCheckResourceAttr(stateResourceName, "notifications.0.new_message.0.badge_count_enabled", "false"),
					resource.TestCheckResourceAttr(stateResourceName, "post_webhook_retry_count", "0"),
					resource.TestCheckResourceAttr(stateResourceName, "post_webhook_url", ""),
					resource.TestCheckResourceAttr(stateResourceName, "pre_webhook_retry_count", "0"),
					resource.TestCheckResourceAttr(stateResourceName, "pre_webhook_url", ""),
					resource.TestCheckResourceAttr(stateResourceName, "webhook_filters.#", "0"),
					...
					resource.TestCheckResourceAttr(stateResourceName, "read_status_enabled", "true"),
					resource.TestCheckResourceAttr(stateResourceName, "typing_indicator_timeout", "5"),
