---
page_title: "twilio_sip_domain_credential_list_mappings Data Source - twilio"
subcategory: "SIP"
description: |-
...
- `account_sid` (String) The SID of the account that owns the SIP domain credential list mappings
- `domain_sid` (String) The SID of the SIP domain to retrieve credential list mappings for
...
- `credential_list_mappings` (List of Object) A list of credential list mappings for the SIP domain (see [below for nested schema](#nestedatt--credential_list_mappings))
