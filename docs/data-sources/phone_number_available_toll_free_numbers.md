---
page_title: "twilio_phone_number_available_toll_free_numbers Data Source - twilio"
...
- `account_sid` (String) The SID of the account to search for available toll-free phone numbers
- `iso_country` (String) The ISO 3166-1 alpha-2 country code to search for available toll-free phone numbers
...
- `available_phone_numbers` (List of Object) A list of available toll-free phone numbers matching the search criteria (see [below for nested schema](#nestedatt--available_phone_numbers))
