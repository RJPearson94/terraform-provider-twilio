---
page_title: "twilio_chat_channel_trigger_webhook Resource - twilio"
...
- `account_sid` (String) The SID of the account that owns this channel trigger webhook
- `date_created` (String) The date and time the channel trigger webhook was created, in RFC 3339 format
- `date_updated` (String) The date and time the channel trigger webhook was last updated, in RFC 3339 format
- `id` (String) The ID of this resource.
- `sid` (String) The unique SID assigned to this channel trigger webhook by Twilio
- `type` (String) The type of the channel webhook
- `url` (String) The absolute URL of the channel trigger webhook resource
